...
public class DotRangoliFullScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FullScreenImageAdapter(DotRangoliFullScreenActivity.this, DataDotRangoli.getData());
